...
export default function Search({ onSearchExc }) {
    ...
    return (
        <div className="search">
            <div className="logo">
                <h1 className='text-lg font-semibold text-gray-600/100 '>Stack Exchange Finder</h1>
            </div>
            <form className="flex w-5/6 items-center" onSubmit={onSubmit}>
                ...
                <div className="relative w-full">
                    ...
                    <input onChange={(event) => setQuery(event.target.value)} type="text" id="voice-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos, Design Templates..." required />
